        ...
        if (!checkSetupFlag()) {
          ...
          if (errorChecking) {
            ...
            if (!matching) {
              ...
              logs("Missing Events:".bgRed,logF(missingEvents),"Matching:".yellow,`${matching}`.red)
            }
            else { logs("Missing Events:".bgRed,logF(missingEvents),"Matching:".yellow,`${matching}`.green) }
          }
          //! ERROR CHECKING
          if (matching 
